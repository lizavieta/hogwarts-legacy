 ...
 * Most methods default to doing nothing and should be overridden for classes that can be
...
public interface MagicEffectRealization {
     ...
     * object's basic MP value ensuring however, that MP does not become negative.
